    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-5">
          ...
          <p className="text-sm text-slate-500 mt-0.5">High-level summary of your fleet</p>
        </div>
      </header>
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm px-8 py-12 flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-sm text-slate-500 max-w-sm">
            The Overview dashboard is under construction. Fleet analytics and KPIs will appear here.
          </p>
        </div>
      </main>
    </div>
